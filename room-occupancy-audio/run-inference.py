# Copied from Edge Impulse Python SDK Exaple:
...
# - Download model with Edge Impulse CLI too:
#    - edge-impulse-linux-runner --download modelfile.eim

# Usage:
# - Run the script with -h argument for expected arguments
# python3 run_inference.py -h
